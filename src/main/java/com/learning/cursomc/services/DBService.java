...
import com.learning.cursomc.domain.Pagamento;
import com.learning.cursomc.domain.PagamentoComBoleto;
import com.learning.cursomc.domain.PagamentoComCartao;
...
import com.learning.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Leandro Barbosa", "lgomesb@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Fulano de Tal", "developer.brq@gmail.com", "21300722088", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363329"));
